...
var fs = require("fs");
var propertiesReader = require("../model/PropertiesReader");
...
apkTool.apkTool_unpack = function(apkpath,desti_path,callBack){
    var exec_code = conf.apkTool.apkToolPath+"/apktool d -f "+ apkpath +" -o "+ desti_path;
    console.log(exec_code);
    process.exec(exec_code,
        function (error, stdout, stderr) {
            if (error !== null) {
                logger.writeErr('exec error: ' + error);
...
apkTool.apkTool_pack = function(src_path,des_dir,apkname,callBack){
    ...
    var exec_code = conf.apkTool.apkToolPath+"/apktool b "+ src_path +" -o "+ target_apk;
    console.log(exec_code);
    process.exec(exec_code,
        function (error, stdout, stderr) {
            if (error !== null) {
...
apkTool.readSign = function(apk_dir,callBack){
    var exec_code = conf.apkTool.apkToolPath+"/getcertificate "+apk_dir;
    process.exec(exec_code,
        function (error, stdout, stderr) {
            if (error !== null) {
                logger.writeErr('exec error: ' + error);
