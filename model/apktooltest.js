 ...
 */
var apktool = require("./ApkTool");
var fs = require("fs");
/*
apktool.apkTool_unpack("/home/chen/youyuan.apk","/home/chen/youyuan_test",function(err,result){
...
apktool.getMd5("/home/chen/下载/aiqiyishipin.apk",function(err,result){
    if(err)
    {
        console.log(err);
        return;
